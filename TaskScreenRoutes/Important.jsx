  ...
  return (
    <View style={{
      ...
      <ScrollView style={styles.tasksContainer}>
        {tasks.filter(task => task.important === true).length ?
          tasks.filter(task => task.important === true).map(item => (<View key={item.id} style={{
          ...
          :
          <Text style={{ color: mode === 'light' ? "black" : "white" }}>No tasks are important as of now.</Text>
        }
